    ...
    Upload: (options: any) => {
        ...
        return {
            render: (el) => {
                ...
                let listIndex = 0;
                const onChangeFile = (uploadFile: any, index: number) => {
                    file = uploadFile;
                    ...
                    const nodeList: any = document.querySelectorAll('.goodies-upload-list__item');
                    if (nodeList.length > 0) {
                        for (let node of nodeList) {
                            node.querySelector('.icon-close').addEventListener('click', (event: any) => {
                                ...
                                setTimeout(() => {
                                    ...
                                    document.getElementById("drapInputFile").addEventListener("change", (event: any) => {
